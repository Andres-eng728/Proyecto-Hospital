...
public class CorreoNotiViewController {
    ...
    private void enviarCorreoSMTP(String destinatario, String asunto, String contenido) throws MessagingException {
        final String remitente = "andresm.zapatal@uqvirtual.edu.co"; // Cambia esto
        final String clave = "kobi ctcs vuqt yxax";        // Contraseña de aplicación (no la normal)
